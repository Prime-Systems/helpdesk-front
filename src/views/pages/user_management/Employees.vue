...
function initFilters1() {
    filters1.value = {
        ...
        branchName: { operator: FilterOperator.AND, constraints: [{ value: null, matchMode: FilterMatchMode.STARTS_WITH }] },
...
// Employee ID is now auto-generated by the backend (AKRB-EMP-XXXXX format)
    ...
    if (employee?.value.firstName?.trim()) {
        try {
            ...
            const userData = {
                ...
                employeeId: employee.value.employeeId || null, // Auto-generated by backend if null
                email: employee.value.email || '',
                phone: employee.value.phone || '',
                profilePictureUrl: employee.value.profilePictureUrl || null,
                gender: employee.value.gender || 'MALE',
                departmentId: employee.value.departmentId || null,
                branchId: employee.value.branchId || null,
    ...
    <div>
        <div class="card">
            ...
            <DataTable
                ...
                :loading="loading1"
                :filters="filters1"
                :globalFilterFields="['firstName', 'lastName', 'branchName', 'departmentName']"
                showGridlines
            ...
            >
                ...
                <Column field="branchName" header="Branch" style="min-width: 12rem">
                    <template #body="{ data }">
                        {{ data.branchName }}
                    </template>
                    <template #filter="{ filterModel }">
            ...
            <div class="flex flex-col gap-4 max-h-[70vh] overflow-y-auto">
                ...
                <div class="grid grid-cols-2 gap-4">
                    <div>
                        ...
                        <Dropdown id="branch" v-model="employee.branchId" :options="branches" optionLabel="name" optionValue="id" placeholder="Select a branch" class="w-full" :invalid="submitted && !employee.branchId" />
                        <small v-if="submitted && !employee.branchId" class="text-red-500">Branch is required.</small>
                    </div>
                    <div>
                        ...
                        <Dropdown
                            ...
                            class="w-full"
                            :invalid="submitted && !employee.departmentId"
                        />
                        <small v-if="submitted && !employee.departmentId" class="text-red-500">Department is required.</small>
                    </div>
                </div>
